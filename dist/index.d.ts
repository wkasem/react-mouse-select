...
type TFinishSelectionCallback = (items: Element[], e: MouseEvent) => void;
type TStartSelectionCallback = (e: MouseEvent) => void;
interface ReactMouseSelectProps {
    /**
...
declare const ReactMouseSelect: ({ containerRef, sensitivity, tolerance, portalContainer, edgeSize, onClickPreventDefault, notStartWithSelectableElements, saveSelectAfterFinish, itemClassName, selectedItemClassName, frameClassName, openFrameClassName, startSelectionCallback, finishSelectionCallback, }: ReactMouseSelectProps) => React.ReactPortal;

export { ReactMouseSelect, ReactMouseSelectProps, TFinishSelectionCallback, TStartSelectionCallback };
