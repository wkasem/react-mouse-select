...
var ReactMouseSelect = function (_a) {
    ...
    var _p = useState(defaultPositionState), positions = _p[0], setPositions = _p[1];
    var borderRef = useRef(null);
    var myPositionRef = useRef(positions);
    ...
    var renderEl = function () {
        return (jsx("div", { className: "".concat(frameClassName, " ").concat(isOpen ? " ".concat(openFrameClassName) : ''), style: {
                position: 'absolute',
